...
class Empolyee(object,metaclass=ABCMeta):
    def __init__(self,name):
        self._name=name
...
class Programmer(Empolyee):
    def __init__(self,name,wokingtime):
        super().__init__(name)
        self._wokingtime=wokingtime

    @property
    def wokingtime(self):
        return self._wokingtime
    
    @wokingtime.setter
    def wokingtime(self,wokingtime):
        self._wokingtime=wokingtime

    def get_money(self):
        return self.wokingtime*150
    
class Seller(Empolyee):
    def __init__(self,name,sellnum):
        super().__init__(name)
    ...
    @sellnum.setter
    def sellnum(self,sellnum):
        self._sellnum,sellnum

    def get_money(self):
        return 1200+self._sellnum*0.05
